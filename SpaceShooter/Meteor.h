...
class Meteor : public ABT::Drawable
{
public:

  Meteor()
  {
    m_mesh = ABT::Main::GetInstance()->m_meshMan.Create(ABT::MeshPath("rock.mesh"));
  }
...
public:
  ...
  void Update(int& score)
  {
    for (int i = (int)m_meteors.size() - 1; i > -1; i--)
    {
      ...
      m_meteors[i]->m_node->Rotate(glm::angleAxis(glm::radians(glm::linearRand(0.1f, 1.5f)), ABT::Z_AXIS), ABT::TS_LOCAL);
