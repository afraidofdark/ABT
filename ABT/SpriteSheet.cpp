...
ABT::SpriteSheet::SpriteSheet()
{
}

ABT::SpriteSheet::SpriteSheet(std::string file)
{
  m_file = file;
}
...
void ABT::SpriteSheet::Load()
{
  ...
  if (FetchEntries())
  {
    m_spriteSheet = Main::GetInstance()->m_textureMan.Create(ABT::SpritePath(m_imageFile));
...
void ABT::SpriteSheet::Init(bool flushClientSideArray)
{
  if (m_initiated)
    return;
...
bool ABT::SpriteSheet::FetchEntries()
{
...
std::vector<ABT::Vertex> ABT::SpriteSheet::CreateQuat(SpriteEntry val)
{
...
ABT::SpriteAnimation::SpriteAnimation()
{
}

ABT::SpriteAnimation::SpriteAnimation(std::shared_ptr<SpriteSheet> spriteSheet)
{
  m_sheet = spriteSheet;
}
...
ABT::EntityType ABT::SpriteAnimation::GetType()
{
  return EntityType::Entity_SpriteAnim;
}

ABT::Surface* ABT::SpriteAnimation::GetCurrentSurface()
{
...
void ABT::SpriteAnimation::Update(float deltaTime)
{
  if (m_sheet == nullptr)
    return;
