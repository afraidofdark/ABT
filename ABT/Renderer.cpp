...
void ABT::Renderer::Render(Drawable* object, Camera* cam, Light* light)
{
  object->m_mesh->Init();
  ...
  for (auto mesh : meshes)
  {
    ...
    RenderState rs = m_mat->m_renderState;
    SetRenderState(rs);
...
void ABT::Renderer::RenderSkinned(Drawable* object, Camera* cam)
{
  object->m_mesh->Init();
  SetProjectViewModel(object, cam);
...
void ABT::Renderer::Render2d(Surface* object, glm::ivec2 screenDimensions)
{
  object->Init();
  ...
  RenderState rs = object->m_mesh->m_material->m_renderState;
  SetRenderState(rs);
...
void ABT::Renderer::Render2d(SpriteAnimation* object, glm::ivec2 screenDimensions)
{
...
void ABT::Renderer::SetRenderState(RenderState state)
{
...
void ABT::Renderer::SetProjectViewModel(Drawable* object, Camera* cam)
{
...
void ABT::Renderer::BindProgram(std::shared_ptr<Program> program)
{
...
void ABT::Renderer::LinkProgram(GLuint program, GLuint vertexP, GLuint fragmentP)
{
...
std::shared_ptr<ABT::Renderer::Program> ABT::Renderer::CreateProgram(std::shared_ptr<Shader> vertex, std::shared_ptr<Shader> fragment)
{
  assert(vertex);
  assert(fragment);
...
void ABT::Renderer::FeedUniforms(std::shared_ptr<Program> program)
{
...
ABT::Renderer::Program::Program()
{
}

ABT::Renderer::Program::Program(std::shared_ptr<Shader> vertex, std::shared_ptr<Shader> fragment)
{
