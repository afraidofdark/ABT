...
ABT::Audio::Audio(std::string file)
{
  m_file = file;
}
...
void ABT::Audio::Init(bool flushClientSideArray)
{
}
...
ABT::EntityType ABT::AudioSource::GetType()
{
  return EntityType::Entity_AudioSource;
}

void ABT::AudioSource::AttachAudio(std::shared_ptr<Audio> audio)
{
  m_audio = audio;
  alSourcei(m_source, AL_BUFFER, audio->m_buffer);
}

void ABT::AudioSource::SetLoop(bool enable)
{
  if (enable)
...
void ABT::AudioSource::SetVolume(float val)
{
  alSourcef(m_source, AL_GAIN, val);
}

void ABT::AudioPlayer::Play(AudioSource* source)
{
  alSourcePlay(source->m_source);
}

void ABT::AudioPlayer::Stop(AudioSource* source)
{
  alSourceStop(source->m_source);
}

void ABT::AudioPlayer::Rewind(AudioSource* source)
{
  alSourceRewind(source->m_source);
}

void ABT::AudioPlayer::Pause(AudioSource* source)
{
